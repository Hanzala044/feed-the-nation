-- ═══════════════════════════════════════════════════════════════════════════════
-- 🏆 ACHIEVEMENT SYSTEM - Database Schema (Updated)
-- ═══════════════════════════════════════════════════════════════════════════════
-- This migration creates the NEW achievement and badge system for donors and volunteers
-- Renames the old achievements table to preserve data
-- ═══════════════════════════════════════════════════════════════════════════════

-- Step 1: Rename old achievements table to preserve existing data
ALTER TABLE IF EXISTS public.achievements RENAME TO achievements_old;

-- Step 2: Create new achievements definition table
...
-- Step 3: Create user_achievements junction table (replaces old achievements table)
...
-- Step 4: Create user_stats table for tracking points and progress
...
-- Step 7: Create RLS Policies for achievements (everyone can read)
CREATE POLICY "Achievements are viewable by everyone"
  ON public.achievements FOR SELECT
  USING (true);

-- Step 8: RLS Policies for user_achievements
...
-- Step 9: RLS Policies for user_stats
...
-- 🎉 MIGRATION COMPLETE
-- ═══════════════════════════════════════════════════════════════════════════════
-- Old achievements table has been renamed to 'achievements_old'
-- You can drop it later with: DROP TABLE IF EXISTS public.achievements_old CASCADE;
-- ═══════════════════════════════════════════════════════════════════════════════
